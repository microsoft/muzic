...
from constraintor import TokenConstraintor
import math
...
class SequenceGenerator(nn.Module):
    def __init__(
            ...
            lyrics=None,
            letter_pos=None,
            note_range: int = _config.note_range,
    ):
    ...
    def _generate(
        ...
        for step in range(max_len + 1):  # one extra step for EOS marker
            ...
            if self.lyrics is not None:
                ...
                if flag != '' and flag.split('_')[0] == TOKEN[self.order % len(TOKEN)]:
        ...
        if self.lyrics is not None:
            ...
            print("Pos: ", len(self.p_cnt))
            print("Pitch: ", len(self.c_cnt))
            
            if _config.PIT_DEBUG and len(self.c_cnt) > 0:
                print("-- Pitch Constraint Debug Info --")
                for c in self.c_cnt:
                    print(c)
                    print()
            if _config.POS_DEBUG and len(self.p_cnt) > 0:
