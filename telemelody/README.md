...
(UPDATE: We provide our [EN](https://huggingface.co/msramuzic/telemelody/resolve/main/lyric2rhythm_en_best.pt) and [ZH](https://huggingface.co/msramuzic/telemelody/resolve/main/lyric2rhythm_zh_best.pt) checkpoints , and corresponding dictionary in ` training/lyric2rhythm/dict`.)
...
(UPDATE: [Here](https://huggingface.co/msramuzic/telemelody/resolve/main/template2melody_best.pt) we provide the template-to-melody model trained on lmd_matched dataset. )
